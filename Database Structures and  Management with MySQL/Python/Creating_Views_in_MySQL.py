...
# Step 1: Create the Lucky_Shrub database if it doesn't exist
cursor.execute("CREATE DATABASE IF NOT EXISTS Lucky_Shrub;")
cursor.execute("USE Lucky_Shrub;")  # Use the Lucky_Shrub database
...
cursor.execute("DELETE FROM Orders;")  # Uncomment this line if you want to clear the table
...
# Step 5: Create a virtual table (view) called OrdersView
cursor.execute('''
...
# Step 8: Retrieve data again from the OrdersView to see the update

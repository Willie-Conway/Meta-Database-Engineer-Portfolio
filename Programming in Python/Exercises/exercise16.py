...
# In this reading, you will explore 
# the behaviour of functions, objects 
# and classes in Python and how the flow 
# of execution of different program statements 
# works to enable better understanding.

# You will perform minor modifications in the 
# given code to observe how it changes the output.

# First, set up a file called class_explore.py 
# that contains the following piece of code. 
...
# Now, modify the code as per the 
# instructions below and observe the 
# changes.

# Step 1: Run the code and observe its 
# output. Take note of every line in the 
# output and how it is different from the 
# output you expected.

# Algorithmically we can view the program 
...
# 5.1 Calling method alpha() over object 
# of class A     

# 5.2 Instantiating object a over class B *. 

# Additional print statements distributed 
# through the code.  


# Step 2: Comment out lines #13, 14, 21, 24, 
# 27 and 28. Run the code again.

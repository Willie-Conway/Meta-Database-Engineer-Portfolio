...
#     - 2.1: Define a function called `basicinfo()` and 
#       add a print statement inside it saying   
...
#        -  3.1: Create a constructor for this class that 
#        initializes a class variable `bal` to `1000` 
#        <br><br>

# 4. Override both functions from the Bank class: `basicinfo()` and `withdraw()`. 

#     - 4.1: Define a function called `basicinfo()` and add a print statement 
#       inside it stating `“This is the Swiss Bank”`  
...
#         class variable `bal`. Instead, print a statement saying `"Insufficient funds"`, 
